...
class WebViewLoginMethodHandler extends LoginMethodHandler {
    ...
    static class AuthDialogBuilder extends WebDialog.Builder {
        ...
        public AuthDialogBuilder(Activity context, String applicationId, Bundle parameters) {
            super(context, applicationId, OAUTH_DIALOG, parameters);
        ...
        public WebDialog build() {
            ...
            return new WebDialog(this.activity, OAUTH_DIALOG, parameters, getTheme(), getListener());
        }
    }
