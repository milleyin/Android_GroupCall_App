...
public class PhoneNumberView {
	...
	public PhoneNumberView(LoginActivity context ) {
		inflater = LayoutInflater.from(context);
		root = inflater.inflate(R.layout.activity_loginactivity_phone_number, null);
		textCountryText = (TextView) root.findViewById(R.id.country_text);
		textCountryCode = (TextView) root.findViewById(R.id.country_code);
		lin_title = root.findViewById(R.id.phone_number_lin);
