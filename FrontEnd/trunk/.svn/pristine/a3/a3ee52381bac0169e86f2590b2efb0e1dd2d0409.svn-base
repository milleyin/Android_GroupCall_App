...
class ImageLoaderEngine {
	...
	/**
	 * Returns URI of image which is loading at this moment into passed {@link com.afmobi.palmchat.util.universalimageloader.core.imageaware.ImageAware}
	 */
	 ...
	 *
	 * @param imageAware {@link com.afmobi.palmchat.util.universalimageloader.core.imageaware.ImageAware} for which display task
	 *                   will be cancelled
	 */
