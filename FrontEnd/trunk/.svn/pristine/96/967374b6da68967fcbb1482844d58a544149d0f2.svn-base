...
public class LoginFragment extends Fragment {
        ...
        loginClient.setBackgroundProcessingListener(
                new LoginClient.BackgroundProcessingListener() {
                    ...
                    public void onBackgroundProcessingStarted() {
                        View view1 = view.findViewById(R.id.com_facebook_login_activity_progress_bar);
    ...
    public void onResume() {
        ...
        View view =getActivity().findViewById(R.id.com_facebook_login_activity_progress_bar);
