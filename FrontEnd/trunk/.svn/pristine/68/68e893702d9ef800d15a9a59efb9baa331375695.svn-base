...
public class GPUImageSketchFilter extends GPUImageFilterGroup {
    public static final String SKETCH_FRAGMENT_SHADER = "" +
            ...
            "void main()\n" +
            "{\n" +
            "mediump vec3 baseColor = texture2D(inputImageTexture, textureCoordinate).rgb;\n" +
            ...
            "\n" +
            "//mag = mag*(pow(baseColor.r, 0.8)*0.1 +0.9);\n" +
            "mag = floor(mag*64.0)/64.0;\n"+
            "mag = mag*(baseColor.r*0.2 +0.8);\n" +
            "\n" +
