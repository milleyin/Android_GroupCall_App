 ...
 */
//@Widget
public class STCalendarView extends FrameLayout {

    /**
     * Tag for logging.
     */
    private static final String LOG_TAG = STCalendarView.class.getSimpleName();
    ...
    public interface OnDateChangeListener {
         ...
         */
        public void onSelectedDayChange(STCalendarView view, int year, int month, int dayOfMonth);
    }
    ...
    public STCalendarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public STCalendarView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, 0);

        // initialization based on locale
        setCurrentLocale(Locale.getDefault());

        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.STCalendarView,
                R.attr.calendarViewStyle, 0);
        mShowWeekNumber = attributesArray.getBoolean(R.styleable.STCalendarView_st_showWeekNumber,
                DEFAULT_SHOW_WEEK_NUMBER);
        mFirstDayOfWeek = attributesArray.getInt(R.styleable.STCalendarView_st_firstDayOfWeek,
                //LocaleData.get(Locale.getDefault()).firstDayOfWeek);
                Calendar.getInstance().getFirstDayOfWeek());
        String minDate = attributesArray.getString(R.styleable.STCalendarView_st_minDate);
        if (TextUtils.isEmpty(minDate) || !parseDate(minDate, mMinDate)) {
            parseDate(DEFAULT_MIN_DATE, mMinDate);
        }
        String maxDate = attributesArray.getString(R.styleable.STCalendarView_st_maxDate);
        ...
        mShownWeekCount = attributesArray.getInt(R.styleable.STCalendarView_st_shownWeekCount,
                DEFAULT_SHOWN_WEEK_COUNT);
        mSelectedWeekBackgroundColor = attributesArray.getColor(
                R.styleable.STCalendarView_st_selectedWeekBackgroundColor, 0);
        mFocusedMonthDateColor = attributesArray.getColor(
                R.styleable.STCalendarView_st_focusedMonthDateColor, 0);
        mUnfocusedMonthDateColor = attributesArray.getColor(
                R.styleable.STCalendarView_st_unfocusedMonthDateColor, 0);
        mWeekSeparatorLineColor = attributesArray.getColor(
                R.styleable.STCalendarView_st_weekSeparatorLineColor, 0);
        mWeekNumberColor = attributesArray.getColor(R.styleable.STCalendarView_st_weekNumberColor, 0);
        mSelectedDateVerticalBar = attributesArray.getDrawable(
                R.styleable.STCalendarView_st_selectedDateVerticalBar);

        mDateTextAppearanceResId = attributesArray.getResourceId(
                R.styleable.STCalendarView_st_dateTextAppearance, android.R.style.TextAppearance_Small);
        updateDateTextSize();

        mWeekDayTextAppearanceResId = attributesArray.getResourceId(
                R.styleable.STCalendarView_st_weekDayTextAppearance,
                DEFAULT_WEEK_DAY_TEXT_APPEARANCE_RES_ID);

        final Drawable horizontalDivider = attributesArray.getDrawable(R.styleable.STCalendarView_st_dividerHorizontal);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(STCalendarView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(STCalendarView.class.getName());
    }
	*/
    /**
    ...
    public void setDate(long date, boolean animate, boolean center) {
        ...
        if (mTempDate.get(Calendar.HOUR)==mAdapter.mSelectedDate.get(Calendar.HOUR) &&
                mTempDate.get(Calendar.MINUTE)==mAdapter.mSelectedDate.get(Calendar.MINUTE)&&
                mTempDate.get(Calendar.AM_PM)==mAdapter.mSelectedDate.get(Calendar.AM_PM))
        {
            return;
        }
            ...
            mAdapter.registerDataSetObserver(new DataSetObserver() {
                ...
                public void onChanged() {
                    if (mOnDateChangeListener != null) {
                        ...
                        mOnDateChangeListener.onSelectedDayChange(STCalendarView.this,
                    ...
                    if (mOnTimeChangeListener != null) {
                        Calendar selectedDay = mAdapter.getSelectedDay();
                        mOnTimeChangeListener.onSelectedTimeChange(STCalendarView.this,
                                selectedDay.get(Calendar.HOUR),
                                selectedDay.get(Calendar.MINUTE),
                                selectedDay.get(Calendar.AM_PM));
                    }
                }
            });
    ...
    private void setUpListView() {
        ...
        mListView.setOnScrollListener(new OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                STCalendarView.this.onScrollStateChanged(view, scrollState);
            }

            public void onScroll(
                    AbsListView view, int firstVisibleItem, int visibleItemCount,
                    int totalItemCount) {
                STCalendarView.this.onScroll(view, firstVisibleItem, visibleItemCount,
                        totalItemCount);
            }
        });
