...
public final class Profile implements Parcelable {
    ...
    private static FetchProfileCallback mFetchProfileCallback;
        ...
        Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(),
                new Utility.GraphMeRequestWithCacheCallback() {
                    ...
                    public void onSuccess(JSONObject userInfo) {
                        ...
                        if(null!=mFetchProfileCallback) {
                        	mFetchProfileCallback.onSuccess();
                        	mFetchProfileCallback =null;
                        }
                    }
                    ...
                    public void onFailure(FacebookException error) {
                    	   ...
                    	   if(null!=mFetchProfileCallback) {
                           	mFetchProfileCallback.onError(error);
                           	mFetchProfileCallback =null;
                           }
                        return;
                    }
    ...
    /**
     * 设置回调
     * @param fetchProfileCallback
     */
    public static void setFetchProfileCallback(FetchProfileCallback fetchProfileCallback){
    	mFetchProfileCallback = fetchProfileCallback;
    }
     ...
     * @return
     */
    public static FetchProfileCallback getFetchProfileCallback( ){
    	return mFetchProfileCallback;
    }
}
