...
@SuppressLint("NewApi")
public class STNumberPicker extends LinearLayout {

	public static final int MY_MEASURED_STATE_MASK = 0xff000000;
	
	public static final int MY_MEASURED_STATE_TOO_SMALL = 0x01000000;
     ...
     * format().
     */
    private static class TwoDigitFormatter implements STNumberPicker.Formatter {
    ...
    /**
     * The {@link STScroller} responsible for flinging the selector.
     */
    private final STScroller mFlingScroller;

    /**
     * The {@link STScroller} responsible for adjusting the selector.
     */
    private final STScroller mAdjustScroller;
...
//    private SupportAccessibilityNodeProvider mAccessibilityNodeProvider;
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(STNumberPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(STNumberPicker view, int scrollState);
    }
     ...
     */
    public STNumberPicker(Context context) {
        this(context, null);
    }
     ...
     */
    public STNumberPicker(Context context, AttributeSet attrs) {
     ...
     */
    public STNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);

        // process style attributes
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.STNumberPicker, defStyle, 0);
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.STNumberPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mSolidColor = attributesArray.getColor(R.styleable.STNumberPicker_solidColor, 0);

        mSelectionDivider = attributesArray.getDrawable(R.styleable.STNumberPicker_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.STNumberPicker_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.STNumberPicker_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.STNumberPicker_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.STNumberPicker_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.STNumberPicker_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.STNumberPicker_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
                R.styleable.STNumberPicker_virtualButtonPressedDrawable);
        ...
        if (!mHasSelectorWheel) {
            mIncrementButton = (ImageButton) findViewById(R.id.st__increment);
        ...
        // decrement button
        if (!mHasSelectorWheel) {
            mDecrementButton = (ImageButton) findViewById(R.id.st__decrement);
        ...
        mInputText.setInputType(InputType.TYPE_NULL);//根据需求 日期选择控件不允许输入
        ...
        mFlingScroller = new STScroller(getContext(), null, true);
        mAdjustScroller = new STScroller(getContext(), new DecelerateInterpolator(2.5f));
...
//        }
     ...
     */
    private boolean moveToFinalScrollerPosition(STScroller scroller) {
                ...
                if (Math.abs(initialVelocity) > mMinimumFlingVelocity) {
                    ...
                    if (deltaMoveY <= mTouchSlop) { // && deltaTime < ViewConfiguration.getTapTimeout()) {
                        if (mShowSoftInputOnTap) {
                            mShowSoftInputOnTap = false;
//                            showSoftInput(); 根据需求 日期选择控件不允许输入
                        } else {
...
*/
    ...
    public void computeScroll() {
        STScroller scroller = mFlingScroller;
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(STNumberPicker.class.getName());
	...
	*/
    ...
    public static int resolveSizeAndState(int size, int measureSpec, int childMeasuredState) {
        ...
        switch (specMode) {
            ...
            case MeasureSpec.AT_MOST:
                if (specSize < size) {
                    result = specSize | MY_MEASURED_STATE_TOO_SMALL;
                } else {
                    result = size;
                }
                break;
        ...
        return result | (childMeasuredState & MY_MEASURED_STATE_MASK);
    }
     ...
     */
    private void onScrollerFinished(STScroller scroller) {
    ...
    private boolean updateInputTextView() {
        ...
        PalmchatLogUtils.e("STNumberPicker", text);
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            STNumberPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            STNumberPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                STNumberPicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (STNumberPicker.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (STNumberPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (STNumberPicker.this.isEnabled()) {
                                STNumberPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (STNumberPicker.this.isEnabled()) {
                                ...
                                STNumberPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(STNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(STNumberPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(STNumberPicker.this.isEnabled());
                event.setSource(STNumberPicker.this, virtualViewId);
                requestSendAccessibilityEvent(STNumberPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(STNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(STNumberPicker.this, virtualViewId);
            info.setParent(STNumberPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(STNumberPicker.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(STNumberPicker.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(STNumberPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(STNumberPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(STNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(STNumberPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
