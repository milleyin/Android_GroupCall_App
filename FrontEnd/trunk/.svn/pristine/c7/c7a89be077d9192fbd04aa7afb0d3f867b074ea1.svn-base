...
import com.afmobi.palmchat.util.universalimageloader.core.assist.FailReason.FailType;
...
import com.afmobi.palmchat.util.universalimageloader.core.decode.ImageDecodingInfo;
import com.afmobi.palmchat.util.universalimageloader.core.download.ImageDownloader;
import com.afmobi.palmchat.util.universalimageloader.core.download.ImageDownloader.Scheme;
 ...
 * display it in {@link com.afmobi.palmchat.util.universalimageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public void run() {
		...
		try {
			...
			bmp = configuration.memoryCache.get(memoryCacheKey);//http://54.77.182.152:34588/d/afid=a60528325&pixel=160x160_336x348
			if (bmp == null) {
				bmp = tryLoadBitmap();
