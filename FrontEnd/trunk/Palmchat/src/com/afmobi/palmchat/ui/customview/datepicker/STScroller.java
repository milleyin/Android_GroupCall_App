...
public class STScroller  {
     ...
     */
    public STScroller(Context context) {
        this(context, null);
    }
     ...
     */
    public STScroller(Context context, Interpolator interpolator) {
     ...
     */
    public STScroller(Context context, Interpolator interpolator, boolean flywheel) {
        mFinished = true;
