package com.afmobi.palmchat.ui.customview.dragsort;
    ...
    public boolean onSingleTapUp(MotionEvent ev) {
        if (mRemoveEnabled && mRemoveMode == CLICK_REMOVE) {
            if (mClickRemoveHitPos != MISS) {
            	AppDialog appDialog = new AppDialog(mDslv.getContext());
            	appDialog.createConfirmDialog(mDslv.getContext(), mDslv.getContext().getString(R.string.delete_friend_dialog_content), new OnConfirmButtonDialogListener() {
					@Override
