 ...
 * @author Transsion
 */
public class AccoutntsHistoryAdapter extends BaseAdapter implements IAdapterBroadcastUitls {

    private final String TAG = AccoutntsHistoryAdapter.class.getSimpleName();
    /**
     * Context
     */
     ...
     * @param
     */
    public AccoutntsHistoryAdapter(Activity activity) {
        ...
        adapterBroadcastUitls = new AdapterBroadcastUitls(mActivity, BroadcastDetailActivity.FROM_OFFICIAL_ACCOUNT);
    ...
    public void setCurPAccountsId(String curAccountId) {
        this.mCurPAccountId = curAccountId;
        if (!TextUtils.isEmpty(mCurPAccountId)) {
            adapterBroadcastUitls.setCurPAccountId(mCurPAccountId);
        }
    }
