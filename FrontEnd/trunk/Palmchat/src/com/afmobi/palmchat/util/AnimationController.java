...
public class AnimationController
{
	 ...
	 * @return
	 */
	public static ObjectAnimator createTranslationYAnimation(long duration, View view, float oriCoord, float goalCoord) {
		ObjectAnimator animator = ObjectAnimator.ofFloat(view,View.Y,oriCoord,goalCoord);
	 ...
	 * @return
	 */
	public static  ObjectAnimator  createRotateAnimation(long duration,View view) {
		ObjectAnimator animator = ObjectAnimator.ofFloat(view,View.ROTATION,0,360f);
		animator.setDuration(duration);
		return animator;
	}
	 ...
	 * @return
	 */
	public static ObjectAnimator createScaleAnimation(long duration, View view, float oriCoord, float goalCoord, Property<View, Float> scale) {
		ObjectAnimator animator = ObjectAnimator.ofFloat(view,scale,oriCoord,goalCoord);
		animator.setDuration(duration);
		return animator;
	}
	 ...
	 * @return
	 */
	public static ObjectAnimator createAlphaAnimation(long duration, View view, float oriCoord, float goalCoord) {
		ObjectAnimator animator = ObjectAnimator.ofFloat(view,View.ALPHA,oriCoord,goalCoord);
		animator.setDuration(duration);
		return animator;
	}
}