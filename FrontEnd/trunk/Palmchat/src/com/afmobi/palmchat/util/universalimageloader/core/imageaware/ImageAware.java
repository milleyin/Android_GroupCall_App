 ...
 * through {@link com.afmobi.palmchat.util.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.afmobi.palmchat.util.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	String getTag( );//add by wxl 记录当前ImageView需要下载的url或uri的路径 用于列表中复用的时候可能造成的ImageView和uri不匹配问题
	void setTag(String tag);//add by wxl 记录当前ImageView需要下载的url或uri的路径 用于列表中复用的时候可能造成的ImageView和uri不匹配问题
	/**
	...
	/**
	 * Returns {@linkplain com.afmobi.palmchat.util.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.afmobi.palmchat.util.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.afmobi.palmchat.util.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.afmobi.palmchat.util.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.afmobi.palmchat.util.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.afmobi.palmchat.util.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.afmobi.palmchat.util.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
	 ...
	 * {@link com.afmobi.palmchat.util.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
