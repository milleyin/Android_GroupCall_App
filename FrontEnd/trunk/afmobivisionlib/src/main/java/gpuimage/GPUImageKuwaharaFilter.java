...
public class GPUImageKuwaharaFilter extends GPUImageFilter {
    ...
    private int mStepOffsethLocation;
    ...
    public void onInit() {
        ...
        mStepOffsethLocation = GLES20.glGetUniformLocation(getProgram(), "src_size");
    }
    ...
    public void onOutputSizeChanged(final int width, final int height) {
        ...
        setFloatVec2(mStepOffsethLocation, new float[]{1f/width, 1f/height});
    }
