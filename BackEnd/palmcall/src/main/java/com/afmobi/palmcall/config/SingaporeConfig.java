...
@Configuration
@Profile("singapore")
public class SingaporeConfig extends AbstractConfig {
    ...
    public DataSource dataSource() throws SQLException {
        ...
        dataSource.setUrl(
                "jdbc:mysql://172.17.20.18:3306/palmcall?autoReconnect=true&useUncheckSessionUriicode=true&characterEncoding=utf-8");
        dataSource.setUsername("dengli");
        dataSource.setPassword("t55uj6j17iv8js8us");
    ...
    public JedisConnectionFactory jedisConnectionFactory() {
        ...
        jedisConnectionFactory.setHostName("172.17.20.18");
    ...
    public String MinutesRechargePalmCoinUrl() {
        return "http://172.17.20.17:8079/ProfitServer/campaign";
    }

    @Override
    public String getPalmchatProfileUrl() {
        return "http://172.17.20.25:8088/UserCenter/user/userBriefInfo";
    }
